...
export default function ItemList({productName,productUni,productPrice,productRemove}:Props){
    ...
    return(
        ...
        <View style = {styles.containerList}>
            ...
            <TouchableOpacity style = {styles.listProductRemove} onPress={productRemove}>
