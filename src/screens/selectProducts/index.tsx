...
export default function SelectProduct() {
  ...
  let tudo = products.reduce(
    (initial, product) =>
      initial + Number(product.productPrice) * Number(product.quantidadeUser),
    0
  );
  let itens = products.reduce(
  ...
  return (
    <View style={styles.container}>
      <SubMenuControl />
      <ButtonDefault
        name="Selecione seu produto Aqui"
        fuc={onPressListProduct}
      ></ButtonDefault>
