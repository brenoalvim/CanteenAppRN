...
export  function ConfirmItem(){
    ...
    const [productHere,setProductHere] = useState([{id:"teste",productName:"Gerando info", productPrice:0.0, productUnit:0}])
    ...
    Products.findByBrand(productName).then((item)=> setProductHere(prevState => item))
     ...
     return (
        ...
        <View style = {styles.container}>
            ...
            <View style = {styles.infoValueMult}>
                <Text style = {styles.infoValueMultText}>R$ {((productHere[0].productPrice)*quantidade).toFixed(2)}</Text>
            </View>


            <View style={styles.containerControll} >
                <TouchableOpacity style ={styles.buttonDecrease} onPress={diminuirQuantidade}>
                    ...
                    <TouchableOpacity style = {styles.buttonIncrease} onPress={aumentarQuantidade}>
