...
export default function ConfirmSales(){
    ...
    function Confirmar(obj){
        ...
        navigation.navigate("TicketGerado",{meio:obj,total:router.params.total,troco:0})
 ...
 const [ticket, setTicket] = useState("100")
    ...
    <View style={styles.containerItensInfo}>
        <View style={styles.itensInfo}>
            <Text style={styles.itensinfoTotalText} >
                {router.params.itens}
            </Text>
            <TouchableOpacity >
        ...
        <View style={styles.itensInfoTotal}>
            ...
            <Text style={styles.itensInfoText} > R$: {(router.params.total).toFixed(2)}</Text>
        </View>
      </View>  
        ...
        <View style={styles.containerFormsPG}>
            ...
            <TouchableOpacity style={styles.buttonFormsPG}  onPress={()=>{Confirmar("pix")}}>
                <Text style={styles.buttonFormsPGText}>Pix</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.buttonFormsPG} onPress={()=>{Confirmar("cartão")}}>
                <Text style={styles.buttonFormsPGText}  >Cartão</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.buttonFormsPG}onPress={()=>{Confirmar("À Prazo")}}>
